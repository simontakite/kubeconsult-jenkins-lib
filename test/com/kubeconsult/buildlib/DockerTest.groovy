...
class DockerTest {
    ...
    void withRegistry() {
        ...
        def args = docker.withRegistry("https://com.KubeConsult/test", 'credentials') {
            return "fromClosure"
        }
        assertEquals("https://com.KubeConsult/test", args[0])
    ...
    void withRegistryWithoutCredentials() {
        ...
        def args = docker.withRegistry("https://com.KubeConsult/test") {
            return "fromClosure"
        }
    ...
    void withServer() {
        ...
        def args = docker.withServer("https://com.KubeConsult/test", 'credentials') {
            return "fromClosure"
        }
        assertEquals("https://com.KubeConsult/test", args[0])
        assertEquals('credentials', args[1])
    ...
    void withServerWithoutCredentials() {
        ...
        def args = docker.withServer("https://com.KubeConsult/test") {
            return "fromClosure"
        }
    ...
    void build() {
        ...
        def args = docker.build("com.KubeConsult/test/app:123", "app")

        assertEquals("com.KubeConsult/test/app:123", args[0])
    ...
    void buildWithoutArgs() {
        ...
        def args = docker.build("com.KubeConsult/test/app:123")
