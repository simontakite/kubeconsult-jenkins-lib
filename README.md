![KubeConsult logo](https://KubeConsult.com/images/logo.png)
# kubeconsult-build-lib
...
```
@Library('github.com/KubeConsult/ces-build-lib@6cd41e0')
...
* When build executors are docker containers and you intend to use their Docker host in the Pipeline: Please see [#8](https://github.com/KubeConsult/ces-build-lib/issues/8#issuecomment-353584252).
...
* `https://jitpack.io/com/github/KubeConsult/ces-build-lib/9fa7ac4/ces-build-lib-9fa7ac4.jar`
* `https://jitpack.io/com/github/KubeConsult/ces-build-lib/9fa7ac4/ces-build-lib-9fa7ac4-sources.jar`

Current version is [![](https://jitpack.io/v/KubeConsult/ces-build-lib.svg)](https://jitpack.io/#KubeConsult/ces-build-lib).<br/> 
For further details and options refer to the [JitPack website](https://jitpack.io/#KubeConsult/ces-build-lib).
...
See [MavenLocal](src/com/KubeConsult/ces/cesbuildlib/MavenLocal.groovy)
...
See [MavenInDocker](src/com/KubeConsult/ces/cesbuildlib/MavenInDocker.groovy)
...
Simple Example: 
```
mvn.useDeploymentRepository([id: 'ces', url: 'https://ecosystem.KubeConsult.com/nexus', credentialsId: 'nexusSystemUserCredential', type: 'Nexus3'])
...
For an example see [KubeConsult/command-bus](https://github.com/KubeConsult/command-bus).
...
<distributionManagement>
    <site>
        <id>ces</id>
        <name>site repository KubeConsult ecosystem</name>
...
For an example see [KubeConsult/continuous-delivery-slides-example](https://github.com/KubeConsult/continuous-delivery-slides-example/)
...
See [Maven](src/com/KubeConsult/ces/cesbuildlib/MavenInDocker.groovy)
...
* `pushGitHubPagesBranch('folderToPush', 'commit Message')` - Commits and pushes a folder to the `gh-pages` branch of 
   ...
   * Example: [KubeConsult/continuous-delivery-slides-example](https://github.com/KubeConsult/continuous-delivery-slides-example/) 
...
* `mountDockerSocket()`: Setting this to `true` mounts the docker socket into the container.  
   ...
   This is also used by [MavenInDocker](src/com/KubeConsult/ces/cesbuildlib/MavenInDocker.groovy)
...
* `installDockerClient(String version)`: Installs the docker client with the specified version inside the container.  
   ...
   For an exampl see [here](https://github.com/KubeConsult/continuous-delivery-docs-example) 
