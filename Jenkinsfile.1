...
node('docker') {
    ...
    def kubeconsultBuildLib = libraryFromLocalRepo().com.kubeconsult.buildlib
    ...
    catchError {
        ...
        stage('SonarQube') {
            ...
            def sonarQube = kubeconsultBuildLib.SonarQube.new(this, 'kubeconsult-sonar')
...
def libraryFromLocalRepo() {
    ...
    library(identifier: 'kubeconsult-build-lib@snapshot', retriever: legacySCM(scm))
}