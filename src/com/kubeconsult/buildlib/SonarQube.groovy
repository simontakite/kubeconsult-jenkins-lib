...
class SonarQube implements Serializable {
     ...
     *
     * Will only work after {@link #analyzeWith(com.kubeconsult.buildlib.Maven)} is called. This is how the
    ...
    protected AnalysisStrategy determineAnalysisStrategy() {
        ...
        // No signature of method: com.kubeconsult.buildlib.SonarCloud.determineAnalysisStrategy() is applicable for argument types: () values: []
